...
class _FakeUrlLauncherApi implements UrlLauncherApi {
  ...
  @override
  Future<bool> launchUrl(String url, Map<String?, String?> headers,
      [String? forcePackageName]) async {
  ...
  @override
  Future<List<String>> listUrlAvailablePackages(String arg_url) {
    // TODO: implement listUrlAvailablePackages
